...
@Component
public class EmailTemplatePatient {


    public String patientConfirmationRequest(String firstName, String link) {
        return "<!DOCTYPE html>\n" +
                ...
                "                              <h1 style=\"margin: 0; font-size: 24px; line-height: normal; " +
                "font-weight: bold;\"> REGISTRATION CONFIRMATION</h1>\n" +
                "                            </div>\n" +
                "                            </td>\n" +
                "                          </tr>\n" +
                "                        </tbody>\n" +
                ...
                "                        \n" +
                "                        <tr>\n" +
                "                          <td align=\"left\" style=\"font-size:0px;padding:1rem 2rem;word-break:break-word;\">\n" +
                "                            <div style=\" font-style: italic; background-color: lightgray; " +
                "padding:1rem 1rem; font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;" +
                "line-height:24px;text-align:left;color:#434245;\">This link will only last for 60 minutes.</div>\n" +
                "                          </td>\n" +
                "                        </tr>\n" +
                "                        <tr>\n" +
